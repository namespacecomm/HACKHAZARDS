          ...
          <div className="bg-white sm:text-[13px] text-[11px] p-2 rounded ">
            <p className="mx-[20px] py-[5px]">
              <ul className="list-disc">
                <li>
                  1-Password Families 1-year plan worth USD 299 to each member
                </li>
                <li>
                  Sublime Text/ Sublime Merge license worth USD 99 to each
                  member
                </li>
                <li>Beeceptor credits worth USD 240</li>
                <li>
                  Wolfram One personal edition 1-year subscription plus Wolfram
                  Alpha Pro 1-year subscription to each member worth USD 375
                  each
                </li>
                <li>
