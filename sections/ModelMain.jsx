          ...
          <div className="bg-white sm:text-[18px] text-[11px] p-2 rounded ">
            <p className="mx-[20px] py-[5px]">
              <ul className="list-disc">
                ...
                <li>
                  $100 for the best project for beginners just starting out on
                  Solana
                </li>
              </ul>
            </p>
          ...
          <div className="bg-white sm:text-[18px] text-[11px] p-2 rounded ">
            <p className="mx-[20px] py-[5px]">
              <ul className="list-disc">
                ...
                <li>
                  Top 5 Projects among the rest of the projects built on Tezos -
                  40 USD each: $200
                </li>
              </ul>
            </p>
          ...
          <div className="bg-white sm:text-[18px] text-[11px] p-2 rounded ">
            <p className="mx-[20px] py-[5px]">
              <ul className="list-disc">
                <li>
                  {" "}
                  Some selected projects would be eligible to receive free or
                  discounted auditing from Quill Audits up to a maximum pool of
                  2,000 USD
                </li>
              </ul>
            </p>
          ...
          <div className="bg-white sm:text-[18px] text-[11px] p-2 rounded ">
            <p className="mx-[20px] py-[5px]">
              <ul className="list-disc">
                <li>
                  {" "}
                  $250 to the best project using XX network’s integrations
                </li>
                <li>
                  $150 to the second-best project using XX network’s
                  integrations
                </li>
                <li>
                  $100 to the third-best project using XX network’s integrations
                </li>
              </ul>
            </p>
          </div>
        ...
        <div className="lg:w-[50vw] w-[90vw] flex flex-col lg:mt-[50px] sm:mt-[150px] ">
          ...
          <div className="bg-white sm:text-[18px] text-[11px] p-2 rounded ">
            <p className="mx-[20px] py-[5px]">
              <ul className="list-disc">
                <li>
                  Most innovative project using verbwire will receive $45 worth
                  of verbwire credits
                </li>
              </ul>
            </p>
